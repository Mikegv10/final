...
public class Info {
    ...
    /*private String info="Scrum es un proceso de gestión y control que reduce la complejidad en el desarrollo de productos para satisfacer \n las necesidades de los clientes."
            + "La gerencia y los equipos de Scrum trabajan juntos alrededor de requisitos y tecnologías \n para entregar productos funcionando de manera incremental usando el empirismo. "
            ...
            + "Ken Schwaber y Jeff Sutherland han escrito La Guía Scrum para explicar Scrum de manera clara y simple. ";*/

    
    
 /*   private String info="El desarrollo ágil de software envuelve un enfoque para la toma de decisiones en los proyectos de software, que se refiere a \nmétodos de ingeniería del software basados en el desarrollo iterativo e incremental, donde " +
...
/*    private String info = "• PRODUCT OWNER: \tESTABLECE EL OBJETIVO A TRAVÉS DE UN DESEO A CUMPLIR.\n \t\tREPRESENTA A LOS PATROCINADORES (STAKEHOLDERS).\n\n\n" +
...
"• Cancelando malos proyectos al principio de ellos evitando costos.", //AQUI TERMINE MI CADENA EN POSICION 0
 "Scrum es un proceso de gestión y control que reduce la complejidad en el desarrollo de productos para satisfacer \n las necesidades de los clientes."
            + "La gerencia y los equipos de Scrum trabajan juntos alrededor de requisitos y tecnologías \n para entregar productos funcionando de manera incremental usando el empirismo. "
            + "\n \n Scrum es un marco de trabajo simple que promueve la \n colaboración en los equipos para lograr desarrollar productos complejos. \n\n"
            + "Ken Schwaber y Jeff Sutherland han escrito La Guía Scrum para explicar Scrum de manera clara y simple. ",//AQUI TERMINE MI CADENA EN POSICION 1
 "• PRODUCT OWNER: \tESTABLECE EL OBJETIVO A TRAVÉS DE UN DESEO A CUMPLIR.\n \t\tREPRESENTA A LOS PATROCINADORES (STAKEHOLDERS).\n\n\n" +
"• SCRUM MASTER:\tGUÍA AL EQUIPO A LA IDENTIFICACIÓN DE ENTREGABLES.\n\t\tFACILITA LA COMUNICACIÓN CON EL PRODUCT OWNER.\n\t\tESTABLECE LOS CALENDARIOS Y AGENDAS.\n\n\n" +
"• SCRUM TEAM: \tAUTO ORGANIZADO\n\t\tDE 3 A 9 MIEMBROS.\n\t\tDETERMINAN COMO SE REPARTE EL TRABAJO DE DESARROLLO"//AQUI TERMINE MI CADENA EN LA POSICION 2
